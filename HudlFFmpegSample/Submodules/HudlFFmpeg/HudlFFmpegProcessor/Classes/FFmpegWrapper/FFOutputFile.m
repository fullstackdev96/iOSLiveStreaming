...
//    int openOutputValue = avformat_alloc_output_context2(&outputFormatContext, NULL, [outputFormatString UTF8String], [outputPath UTF8String]);
        int openOutputValue = avformat_alloc_output_context2(&outputFormatContext, NULL, "flv", NULL);
...
//        int returnValue = avio_open(&formatContext->pb, [@"rtmp://192.168.1.101/live/test" UTF8String], AVIO_FLAG_WRITE);
          int returnValue = avio_open(&formatContext->pb, [@"rtmp://192.168.1.101/live/test" UTF8String], AVIO_FLAG_WRITE);
